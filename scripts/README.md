...
1. Copy the `scripts/` folder into the Godot project.
2. Add `scripts/auto_player_spawn_colors.gd` as an Autoload singleton.
3. Add `scripts/terrain_seed_autoconfig.gd` as an Autoload singleton.
4. Edit only `scripts/player_color_palette.gd` when you want to change the list
